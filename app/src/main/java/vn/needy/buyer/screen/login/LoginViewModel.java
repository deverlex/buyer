...
import vn.needy.buyer.screen.forgotPassWd.ForgotPassWdActivity;
import vn.needy.buyer.screen.main.MainActivity;
import vn.needy.buyer.screen.register.RegisterActivity;
...
public class LoginViewModel extends BaseObservable implements LoginContract.ViewModel {
    ...
    public void onForgotPasswordClick() {
        mNavigator.startActivity(ForgotPassWdActivity.class);
    }
