...
public class ForgotPassWdViewModel extends BaseObservable implements ForgotPassWdContract.ViewModel{
    private static final String TAG = ForgotPassWdViewModel.class.getName();
    ...
    public ForgotPassWdViewModel(Context context, Application application, Navigator navigator, DialogManager dialogManager) {
        mContext = context;
    ...
    @Override
    public void setPresenter(ForgotPassWdContract.Presenter presenter) {
